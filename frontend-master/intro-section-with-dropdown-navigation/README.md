...
**⚠️ IMPORTANT ⚠️: Please be sure not to share our design files with anyone else. Include `.gitignore` files in the starter code  to help prevent you from accidentally uploading it to GitHub. Another easy way to prevent this is to keep the design file separate from your codebase.**
